...
class UniversalCommentHelper
{
    private $request;

    public function __construct(private EngineInterface $engine, private RequestStack $requestStack, private PaginatorInterface $paginator)
    {
    }
